...
export default function CreateListing() {
  ...
  // state for the tracking the error
  ...
  // get the nesssassary details from the useEffect details
  useEffect(() => {
    const fetchListing = async () => {
      const listingID = params.listingID;
      // get the listing for the page
  ...
  // implementing the handleChange form the track the changed Form data
  ...
  // implemting the handle submit function to the submit function
  ...
  return (
    <main className="p-3 max-w-5xl mx-auto drop-shadow-lg">
